...
Include ("\\script\\missions\\leaguematch\\wlls_autoexec.lua")	--Li猲 u
...
Include("\\script\\江南区\\金山岛\\addnpcandtrap.lua")--Vi Son Dao	
...
if (GetProductRegion() == "vn") then
	...
	Include("\\script\\两湖区\\南岳镇\\heisha_autoexec.lua")	--Map Hac Sa Dong
