...
function default_talk()
	...
	if ((UTask_world42 == 0) and (GetLevel() >= 80) and (GetReputeLevel(GetRepute()) >= 7)) then		-- ÈÎÎñÆô¶¯£¬ÉùÍûµÈ¼¶ºÍÉùÍûÖµµÄ¹ØÏµ²»ÊÇºÜÃ÷È·£¬ÒªÎÊÃ÷°×
		Talk(6,"U42_get","VÖ Binh Thµnh M«n: Nghe nãi gÇn ®©y trong thµnh x¶y ra nhiÒu vô tiÓu hµi tö v« cí bŞ mÊt tİch?","VÖ Binh Êt: §óng vËy! Míi võa råi Lı ®¹i thÈm cã ®Õn nhê ta t×m gióp NhŞ hµi tö cña nµng bŞ mÊt tİch...","Ng­êi ch¬i: NhŞ vŞ, cã thÓ nãi râ h¬n cho t¹i h¹ ®­îc biÕt hay kh«ng?","VÖ Binh Gi¸p: Ha ha, vŞ ®¹i hiÖp nµy d¸ng vÎ ®­êng ®­êng, anh minh thÇn vâ, xem ra lµ muèn qu¶n viÖc bÊt b×nh nµy hay sao?","Ng­êi ch¬i: Kh¸ch khİ, gÆp chuyÖn bÊt b×nh rót ®ao t­¬ng trî lµ bæn phËn cña nh÷ng ng­êi hµnh tÈu giang hå.","VÖ Binh Êt: Ai nha, ®ªm nay tiÒn th­ëng d­êng nh­ kh«ng mang ®ñ a!")
	else
...
function U42_get()
	Say("§óng vËy! H·y cßn thiÕu 5 v¹n l­îng.",2,"Hai vŞ ®¹i ca thó vŞ thËt/yes1","Dèi ®­îc ng­êi nh­ng kh«ng dèi ®­îc m×nh!/no")
end;
